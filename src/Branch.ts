...
export const branchAddress = (b: Branch) =>
  [
    (b.PostalAddress.BuildingNumber + " " + b.PostalAddress.StreetName).trim(),
    b.PostalAddress.TownName,
    ...(b.PostalAddress.CountrySubDivision || []),
...
export function useBranches() {
  return branches?.data?.[0]?.Brand?.[0]?.Branch as unknown as Branch[];
}
